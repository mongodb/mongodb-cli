...
// Source: github.com/mongodb/mongodb-cli/mongocli/v2/internal/store (interfaces: GlobalAPIKeyLister,GlobalAPIKeyDescriber,GlobalAPIKeyUpdater,GlobalAPIKeyCreator,GlobalAPIKeyDeleter)
