...
//go:generate mockgen -destination=../mocks/mock_release_version.go -package=mocks github.com/mongodb/mongodb-cli/mongocli/v2/internal/version ReleaseVersionDescriber
