...
//go:generate mockgen -destination=../mocks/mock_clusters.go -package=mocks github.com/mongodb/mongodb-cli/mongocli/v2/internal/store ClusterLister,OpsManagerClusterDescriber
