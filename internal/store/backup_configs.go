...
//go:generate mockgen -destination=../mocks/mock_backup_config.go -package=mocks github.com/mongodb/mongodb-cli/mongocli/v2/internal/store BackupConfigGetter,BackupConfigLister,BackupConfigUpdater
