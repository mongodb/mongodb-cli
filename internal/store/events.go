...
//go:generate mockgen -destination=../mocks/mock_events.go -package=mocks github.com/mongodb/mongodb-cli/mongocli/v2/internal/store OrganizationEventLister,ProjectEventLister,EventLister
