...
//go:generate mockgen -destination=../mocks/mock_backup_sync.go -package=mocks github.com/mongodb/mongodb-cli/mongocli/v2/internal/store SyncsLister,SyncsDescriber,SyncsCreator,SyncsUpdater,SyncsDeleter
