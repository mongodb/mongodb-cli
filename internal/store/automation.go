...
//go:generate mockgen -destination=../mocks/mock_automation.go -package=mocks github.com/mongodb/mongodb-cli/mongocli/v2/internal/store AutomationGetter,AutomationUpdater,AutomationStatusGetter,AutomationPatcher,CloudManagerClustersLister,CloudManagerClustersDescriber,CloudManagerClustersDeleter
