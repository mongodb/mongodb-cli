...
//go:generate mockgen -destination=../mocks/mock_monitoring.go -package=mocks github.com/mongodb/mongodb-cli/mongocli/v2/internal/store MonitoringStarter,MonitoringStopper
