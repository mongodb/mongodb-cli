...
//go:generate mockgen -destination=../mocks/mock_feature_control_policy.go -package=mocks github.com/mongodb/mongodb-cli/mongocli/v2/internal/store FeatureControlPoliciesLister,FeatureControlPoliciesUpdater
