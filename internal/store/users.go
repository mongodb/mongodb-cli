...
//go:generate mockgen -destination=../mocks/mock_users.go -package=mocks github.com/mongodb/mongodb-cli/mongocli/v2/internal/store UserCreator,UserDescriber,UserDeleter,UserLister,TeamUserLister
