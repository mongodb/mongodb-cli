...
//go:generate mockgen -destination=../mocks/mock_backup_snapshot_schedule.go -package=mocks github.com/mongodb/mongodb-cli/mongocli/v2/internal/store SnapshotScheduleDescriber,SnapshotScheduleUpdater
