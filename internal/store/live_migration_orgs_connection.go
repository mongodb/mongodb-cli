...
//go:generate mockgen -destination=../mocks/mock_live_migration_orgs_connection.go -package=mocks github.com/mongodb/mongodb-cli/mongocli/v2/internal/store OrganizationsConnector,OrganizationsDescriber
