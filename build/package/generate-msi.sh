...
LINKER_FLAGS="-s -w -X github.com/mongodb/mongodb-cli/mongocli/v2/internal/version.Version=${VERSION_GIT} -X github.com/mongodb/mongodb-cli/mongocli/v2/internal/version.GitCommit=${COMMIT}"
